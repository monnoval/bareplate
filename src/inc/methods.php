...
function get_default_lang_page_id( $id, $post_type = 'page' ){
...
function get_page_attachments( $page_id, $post_type = 'page' ) {
  ...
  $argsThumb = array(
    ...
    'post_parent'    => get_default_lang_page_id( $page_id, $post_type ),
...
function has_page_attachments( $page_id, $media_tag = '', $post_type = 'page' ) {
